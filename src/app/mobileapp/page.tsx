...
const learningPaths = [
  {
    title: "React Native",
    description:
      "Learn to build cross-platform mobile apps with JavaScript and React.",
    icon: Smartphone,
  ...
  },
  {
    title: "Flutter",
    description:
      "Master Google's UI toolkit for building natively compiled applications for mobile, web, and desktop from a single codebase.",
    icon: Smartphone,
  ...
  },
  {
    ...
    description:
      "Get started with native iOS app development using Swift and Xcode.",
    icon: Smartphone,
  ...
  },
  {
    ...
    description:
      "Learn the fundamentals of native Android app development with Kotlin.",
    icon: Smartphone,
  ...
  },
  {
    ...
    description:
      "Explore best practices for designing intuitive and user-friendly mobile interfaces.",
    icon: Smartphone,
  ...
  {
    title: "App Deployment (App Store, Play Store)",
    description:
      "Understand the process of publishing your mobile applications to the Apple App Store and Google Play Store.",
    icon: Smartphone,
      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            Master mobile app development through our structured learning paths.
